...
$fieldsToUpdate["verification_doc"];
                ...
                $userVerificationDoc = User::find($currentUser->id);
                ...
                if ($request->hasFile('verification_doc')) {
                    ...
                    $old_image = $userVerificationDoc->verification_doc;
                    $verification_image = $request->file('verification_doc');
                    $imageName = microtime(true) . "." . $verification_image->getClientOriginalExtension();

                    if ($verification_image->move($destinationPath, $imageName)) {
                        $userVerificationDoc->verification_image = $imageName;
                        if ($old_image != '') {
