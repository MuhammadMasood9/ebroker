                    ...
                    <table class="table table-striped" id="table_list" data-toggle="table"
                        ...
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" data-field="customer_document_status" data-formatter="enableDisableSwitchFormatter" data-sortable="false" data-align="center">{{ __('Enable/Disable') }}</th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
@section('script')
    <script>
        ...
        function imageFormatter(value, row) {
            return `<img src="${value}" alt="Document" class="img-thumbnail" style="width: 100px; height: 100px; cursor: pointer;" onclick="showImageModal('${value}')">`;
        }
