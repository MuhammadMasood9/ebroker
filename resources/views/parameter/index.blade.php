                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <table class="table table-striped" id="table_list" data-toggle="table"
                            data-url="{{ url('parameter-list') }}" data-click-to-select="true"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('parameter-update') }}" class="form-horizontal" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12">
                                <input accept="image/svg+xml" name='image' type='file' id="edit_image"
                                    class="filepond" />
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary waves-effect waves-light editParameter"
                        id="btn_submit">{{ __('Save') }}</button>
                    <a id="deleteParameter" class="btn btn-danger">Delete</a>
...
@section('script')
    <script>
        ...
        function setValue(id) {
            ...
            // Get the value of edit_id and store it in paraID when the delete button is clicked
            document.getElementById("deleteParameter").onclick = function() {
                // Retrieve the value from the edit_id input
                let paraID = document.getElementById("edit_id").value;

                // Create the delete URL by replacing the placeholder with paraID
                const deleteUrl = '{{ route('parameter.delete', ':id') }}'.replace(':id', paraID);
