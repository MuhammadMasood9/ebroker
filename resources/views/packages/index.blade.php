                        ...
                        <div class="card-body">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-sm-12 col-md-12 form-group mandatory">
                                    ...
                                    <div>
                                        <input type="radio" id="product-list-promote" name="package_type"
                                            value="product_listing" required>
                                        <label for="product-list-promote">{{ __('Product List and Promote') }}</label>
                                    </div>

                                    {{-- Premium User --}}
                                    <div>
                                        <input type="radio" id="premium-user" name="package_type" value="premium_user"
                                            required>
                                ...
                                <div class="limitations col-md-12">
                                    <div id="property_limitation" class="col-md-12 col-sm-12 form-group">
                                        ...
                                        <input type="radio" id="property-limited" name="typep"
                                            value="add_limited_property">
                                        <label for="property-limited">{{ __('Limited') }}</label>

                                        <input type="radio" id="property-unlimited" name="typep"
                                    ...
                                    <div id="advertisement_limitation" class="col-md-12 col-sm-12 form-group">
                                        ...
                                        <input type="radio" id="advertisement-limited" name="typel"
                                            value="add_limited_advertisement">
                                        <label for="property-limited">{{ __('Limited') }}</label>

                                        <input type="radio" id="property-unlimited" name="typel"
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <table class="table table-striped" id="table_list" data-toggle="table"
                                    data-url="{{ url('package_list') }}" data-click-to-select="true"
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ url('package-update') }}" class="form-horizontal" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mandatory">
                                        <label for="edit_name"
                                            class="form-label col-12 ">{{ __('Package Name') }}</label>
                                        <input type="text" id="edit_name" class="form-control col-12"
                                            placeholder="{{ __('Package Name') }}" name="edit_name"
                                            data-parsley-required="true">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="edit_ios_product_id"
                                            class="form-label col-12 ">{{ __('IOS Product ID') }}</label>
                                        <input type="text" id="edit_ios_product_id" class="form-control col-12"
                                            placeholder="{{ __('IOS Product ID') }}" name="edit_ios_product_id">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <input type="text" id="edit_duration" class="form-control col-12"
                                            placeholder="{{ __('Duration') }}" name="edit_duration" min="1"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <input type="text" id="edit_price" class="form-control col-12" min="0"
                                            placeholder="{{ 'Price' }}" name="edit_price"
                                            data-parsley-required="true">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        {!! Form::select('status', ['0' => trans('OFF'), '1' => trans('ON')], '', [
                                            'class' => 'form-select',
                                            'id' => 'status',
                                        ]) !!}
                                    </div>
                            ...
                            <div class="col-sm-12 col-md-12 form-group mandatory">
                                {{ Form::label('price', __('Type'), ['class' => 'form-label col-12 ']) }}
                                <div>
                                    <input type="radio" id="edit-product-list-promote" name="edit_package_type"
                                        value="product_listing" required>
                                    <label for="edit-product-list-promote">{{ __('Product List and Promote') }}</label>
                                </div>

                                <div>
                                    <input type="radio" id="edit-premium-user" name="edit_package_type"
                                        value="premium_user" required>
                            ...
                            <div class="edit_limitations col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 form-group mandatory" id="for_edit_property">
                                        <input type="radio" id="edit-limited-property" name="edit_typep"
                                            value="edit_limited_property">
                                        <label for="edit-limited-property">{{ __('Limited') }}</label>

                                        <br>
                                        <input type="radio" id="edit-unlimited-property" name="edit_typep"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 form-group mandatory" id="for_edit_advertisement">
                                        ...
                                        <input type="radio" id="edit-limited-advertisement" name="edit_typel"
                                            value="edit_limited_advertisement">
                                        <label for="edit-limited-advertisement">{{ __('Limited') }}</label>
                                        <br>

                                        <input type="radio" id="edit-unlimited-advertisement" name="edit_typel"
    ...
    <script>
        ...
        window.actionEvents = {
            ...
            'click .edit_btn': function(e, value, row, index) {
                const deleteUrl = '{{ route("package.delete", ":id") }}'.replace(':id', row.id);
                $("#deletePackage").attr('href', deleteUrl);
